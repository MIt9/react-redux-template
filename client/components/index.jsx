...
let App = React.createClass({
    ...
    render() {
        ...
        return (
            <div id="game">
                <Barmenu mistakes={game.mistakes} completed={game.completed} startLength={game.startLength}/>
                <Example answer={game.answer} result={game.result} model={game.model}/>
                {game.answer ?
                    <Animation result = {game.result}/> : <Hands fileName = {game.fileName}/>
                }
                {game.answer ? <Moves /> : <Keyboard />}
            </div>
